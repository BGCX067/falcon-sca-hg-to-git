...
public class FighterDAO {
	...
	public Fighter getFighterByGoogleId(String userId) {
		Logger.getLogger(FighterDAO.class.getName()).log(Level.INFO, "Getting {0}", userId);
		...
		Logger.getLogger(FighterDAO.class.getName()).log(Level.INFO, "returning {0}", retval.getScaName());
		return retval;
	}
